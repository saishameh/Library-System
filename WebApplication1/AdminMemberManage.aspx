<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminMemberManage.aspx.cs" Inherits="WebApplication1.AdminMemberManage" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <label>DOB</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" ReadOnly="True" placeholder="DOB"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox11" runat="server" placeholder="A1A 1A1" ReadOnly="True"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server" placeholder="Full Address" ReadOnly="True" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-8 mx-auto">
                                <asp:Button ID="Button1" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User" />
                            </div>
